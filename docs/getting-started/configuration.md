...
export GITHUB_TOKEN=ghp_...  # GitHub classic token for Copilot API
```
...
!!! tip "GitHub token"
To get a GitHub token for Copilot access, see the [GitHub Copilot setup guide](../guides/backends.md#github-copilot).
